...
sensors_actuators::sensors_actuators(Data_Xchange *data,float Ts) : di1(.002,Ts),di2(.002,Ts),big_button(PC_3),counter2(PA_6, PC_7),
                            indexpulse1(PA_8),index1(counter1,indexpulse1), counter1(PB_6, PB_7),indexpulse2(PB_4),index2(counter2,indexpulse2),
                            i_enable(PB_5),laser_on(PB_0), i_des1(PA_5),i_des2(PA_4),uw1(4*6400,16),uw2(4*4096,16)
{
    this->m_data = data;
    i2u.setup(-3.0f,3.0f,0.0f,1.0f);
